...
const createAppointment = async (req, res) => {
    ...
    try {
        ...
        (apt_description, date, time, doctor_id, category_id, location_id, apt_notes, image_path,
         is_bookmarked, created_by, updated_by, patient_id)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [
                apt_description || null, date, time, doctorId, category_id, locationId,
                apt_notes || null, image_path || null, is_bookmarked || null, createdBy, updatedBy, patient_id
            ]
        );
