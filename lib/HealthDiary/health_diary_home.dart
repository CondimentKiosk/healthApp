...
class _HealthDiaryPageState extends State<HealthDiaryPage> {
  ...
  void saveEntry(){
    ...
    final entry = SymptomEntry(timeStamp: DateTime.now(), 
      ...
      body: hasSymptoms ? Form(
        ...
        child: ListView(
          ...
          children: [
            ...widget.symptoms.map((sym){
              ...
              return Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Checkbox(value: ignored, onChanged: (value)=>toggleIgnore(name, value)),
                      const Text("Ignore This Time")
                    ],
                  ),
                  Slider(value: ratings[name]!,
                  min: 1,
                  max: 10,
                  divisions: 9,
                  label: ratings[name]!.round().toString(),
                  onChanged: ignored ? null : (value)=>setState(()=>ratings[name]=value),
                  ),
            ...
            const SizedBox(height: 20,),
            ElevatedButton(onPressed: saveEntry, child: const Text("Save Entry"))
          ],
        ))
        : Center(
          child: Column(
